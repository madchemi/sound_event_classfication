...
from model_resnet_10 import Resnet
...
for i in range(10):
   preprocessing('C:/Users/seoji/Desktop/gist/gist_makerton/archive/fold'+str(i+1)+'/', 'C:/Users/seoji/Desktop/gist/gist_makerton/urban_numpy_set_sr16000/',max_pad_len)
...
# 모델 저장 파일 경로 (확장자 포함)
model_path = os.path.join(model_dir, 'model_parameter_model_resnet_10_{num_epoch}_class10.pth')
